...
from src.auth.dependencies import get_current_user_id, get_user_id_from_path
...
async def chat(
    ...
    if request_user_id != user_id:
        logger.warning(f"Security: User {request_user_id} attempted to access chat for user {user_id}")
