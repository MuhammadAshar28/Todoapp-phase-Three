...
# Tasks: Backend Core & Data Layer for Todo Full-Stack Web Application

**Input**: Design documents from `/specs/1-backend-core-data-layer/`
...
- [ ] T025 [P] [US2] Implement get_tasks method in TaskService with pagination support
- [ ] T026 [US2] Add GET /users/{user_id}/tasks endpoint in tasks.py router
- [ ] T027 [US2] Add pagination query parameters (page, page_size) with defaults
- [ ] T028 [US2] Add response model TaskListResponse with pagination metadata
- [ ] T029 [US2] Add user-scoped query filtering by user_id
- [ ] T030 [US2] Add error handling for invalid pagination params (400)
...
- [ ] T031 [P] [US3] Implement get_task method in TaskService with user_id filter
- [ ] T032 [US3] Add GET /users/{user_id}/tasks/{task_id} endpoint in tasks.py router
- [ ] T033 [US3] Add path parameter validation for task_id (UUID format)
- [ ] T034 [US3] Add 404 response when task_id not found or not owned by user
- [ ] T035 [US3] Add response model TaskResponse
